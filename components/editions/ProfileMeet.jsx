            ...
            >
              ...
              <div className="max-w-[265px] w-full text-center sm:text-left">
                ...
                <Image
                  ...
                  height={247}
                  width={247}
                  className="pt-4 rounded-full object-cover mx-auto sm:mx-0"
                  alt={`Noma Collective community manager - ${manager?.name}`}
                />
              </div>

              {/* Right: Description */}
              <div className="sm:max-w-[540px] w-full flex flex-col gap-2 sm:gap-4 text-center sm:text-left text-[#313131] text-sm sm:text-base font-normal font-Montserrat leading-normal">
