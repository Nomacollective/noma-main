      ...
      <div className="bg-[#FFDA7F]">
        <div className="xl:px-0 sm:px-4 sm:pt-4 pb-8 mx-auto max-w-[950px] w-full flex max-md:flex-col gap-4 md:gap-6 lg:gap-9 xl:gap-[76px]">
          <div className="sm:max-w-[457px] max-sm:bg-[#F4F1E6] flex flex-col justify-between w-full mx-auto pt-0 sm:pt-0">
            ...
            {/* GET STARTED and FREE LOCATION PDF Buttons */}
            <div className="flex flex-col gap-2 justify-center pl-[42px] pb-[40px] max-sm:hidden">
              <button
                type="button"
                ...
                onClick={() => {
                  setShowForm(true);
                  setIsIframeLoading(true); // Reset loading state when showing form
                }}
              >
                GET STARTED
              </button>
            ...
            {/* Form Embed */}
            {showForm && (
              <div className="bg-[#F7F7F7] p-8 rounded-3xl shadow-md w-full max-w-[500px] mt-4 mx-auto relative min-h-[519px]">
                {isIframeLoading && (
                ...
                <iframe
                  ...
                  style={{
                    ...
                    border: "none",
                    borderRadius: "36px",
                    display: isIframeLoading ? "none" : "block", // Hide iframe until loaded
                  }}
