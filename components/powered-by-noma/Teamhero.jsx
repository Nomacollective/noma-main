  ...
  return (
    ...
    >
      <img
        ...
        width={550}
        height={550}
        className="w-[300px] h-[100px] sm:w-[550px] sm:h-[200px]"
      ></img>
      ...
      <div className="flex justify-center ">
        <button className="bg-romance text-[#000000] border border-[romance] text-sm md:text-base font-extrabold leading-normal font-Montserrat sm:px-8 px-4 py-[9px] sm:py-4 rounded-[28px] w-fit mx-auto mt-4 hover:bg-transparent  duration-700">
          {btn}
        </button>
      </div>
    </div>
